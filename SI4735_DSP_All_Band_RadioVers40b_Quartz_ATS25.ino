...
#ifdef IhaveSI5351
//#include <si5351wire.h>   // remove comment for SI5351 !!
#endif
//  fonts
...
void showRDSStation() {
  ...
  if ((FirstLayer) or (ThirdLayer)) {
    tft.setCursor(XFreqDispl + 60, YFreqDispl + 80);
    tft.setTextSize(3);
    tft.setTextColor(TFT_GOLD, TFT_NAVY);
    tft.print("Radio  ");
    tft.setCursor(XFreqDispl + 180, YFreqDispl + 80);
    tft.setTextSize(3);
    tft.setTextColor(TFT_GOLD, TFT_NAVY);
